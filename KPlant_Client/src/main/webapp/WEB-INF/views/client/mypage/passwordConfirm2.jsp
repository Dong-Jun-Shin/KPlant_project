...
<div id="all">
	...
	<div id="passwordDiv">
		<form id="passwordConf2" class="form-inline">
			...
			<table border="1" id="confirm">
				...
				<tr>
					<td class="tr1" id="pwdBefo"><label class="text2">기존
							비밀번호</label></td>
					<td class="tr2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
						type="password" class="form-control" id = "m_pwd2" name = "m_pwd" placeholder="기존 비밀번호를 입력" />
					</td>
			</table>
		...
		<div id="pwdBtnAll">
			<div id="pwdBtn">
				<input type="button" id="pwdConfBtn2" name="updateBtn" value="확인"
